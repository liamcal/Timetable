...
namespace Tests
{
	public class TimetableHelperTests
	{
		...
		public void GetLessonsForStudent()
		{
			...
			Assert.That(TimetableHelper.GetLessonsForStudent(context, testStudent), Is.EquivalentTo(new[] { testClass1, testClass2, testClass3, testClass6 }), "Student timetable should contain 4 lessons");
		}
		...
		public void GetLessonsForStudent_StudentHasNoEnrolments()
		{
			...
			Assert.That(TimetableHelper.GetLessonsForStudent(context, testStudent), Is.Empty, "Student timetable should be empty");
		}
